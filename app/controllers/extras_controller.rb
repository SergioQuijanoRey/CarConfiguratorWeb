class ExtrasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @extra.save
        format.html { redirect_to extra_url(@extra), notice: "Extra was successfully created." }
  ...
  def update
    respond_to do |format|
      if @extra.update(extra_params)
        format.html { redirect_to extra_url(@extra), notice: "Extra was successfully updated." }
  ...
  private
    ...
    def extra_params
      params.require(:extra).permit(:nombre, :precio, :image)
    end
end
